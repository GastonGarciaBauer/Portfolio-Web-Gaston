        ...
        <>
            ...
            <div className="container row d-flex flex-wrap justify-content-center">
                <div className="col-12 col-sm-8">
                    ...
                    <InfoCard title={(<><a className="card-title" target="_blank" href='https://github.com/GastonGarciaBauer/ProtonReloaded'>Protón Reloaded</a></>)} url={"HTML, CSS, React, Bulma, PHP, MySql"} urlTitle={"Tienda virtual de insumos para mascotas y gestión de turnos"} img={proti} description={"Plataforma integral de venta de insumos para mascotas y gestor de turnos para peluquería canina. Si bien es un proyecto diferente, se basó en la idea de 'Protón'. [Proyecto final de la Tecnicatura]."} LinkTo={'https://github.com/GastonGarciaBauer/ProtonReloaded'} />
                    
                    <InfoCard title={(<><a className="card-title" target="_blank" href='https://github.com/GastonGarciaBauer/ecommerce_mascotas'>Protón</a></>)} url={"HTML, CSS, JS, PHP. MySql"} urlTitle={"Tienda virtual de insumos para mascotas"} img={logo_proton} description={"Plataforma tipo e-commerce de venta de insumos para mascotas. Proyecto final de la materia ~ Laboratorio IV~."} LinkTo={'https://github.com/GastonGarciaBauer/ecommerce_mascotas'} />
