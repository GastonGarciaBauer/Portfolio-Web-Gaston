        ...
        <>
            ...
            <div className="container row d-flex flex-wrap justify-content-center my-5">
                <div className="col-12 col-sm-8">
                    ...
                    <p className="pb-5">Mi objetivo es consolidarme como un gran programador y seguir aprendiendo día a día para estar actualizado de las nuevas tendencias y tecnologías. Te invito a que sigas recorriendo mi CV para que puedas conocerme mejor. </p>
                    <ImageSlider />
